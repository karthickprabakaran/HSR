...
const About = () => {
  ...
  return (
    <section ref={sectionRef} className="py-16 md:py-18 lg:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-gray-700 text-base md:text-lg leading-relaxed">
                ...
                natural and botanical elements from the garden all around the
                spa... indoor plants, tables crafted from tree trunks and
                lavender placed on treatment beds.
              </p>
            </div>
            ...
            <div className="pt-4">
              <button
                className={`${colors.primary} ${buttons.medium} transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl`}
              >
                Learn More
              </button>
            </div>
          ...
          {/* Right Videos Grid */}
          <div
            className={`grid grid-cols-2 gap-4 ${isVisible ? "animate-slideInRight" : "opacity-0"}`}
          >
            {/* Large Video - Top Right */}
            <div className="col-span-1">
              <div
                className={`overflow-hidden rounded-lg shadow-lg transform transition-all duration-700 hover:scale-105 ${
        ...
        <div
          className={`mt-16 md:mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 ${
            isVisible ? "animate-fadeInUp delay-800" : "opacity-0"
          }`}
        >
          {[
